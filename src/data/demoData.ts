...
export const teams: Team[] = [
  { 
    ...
    members: [
      { id: 'member-1', name: 'María García', role: 'CEO', roleEs: 'CEO' },
      { id: 'member-2', name: 'Carlos Rodríguez', role: 'COO', roleEs: 'COO' },
      { id: 'member-3', name: 'Ana Martínez', role: 'CHRO', roleEs: 'CHRO' },
      { id: 'member-4', name: 'Luis Fernández', role: 'CFO', roleEs: 'CFO' },
      { id: 'member-5', name: 'Elena Torres', role: 'CTO', roleEs: 'CTO' },
      { id: 'member-6', name: 'Pablo Sánchez', role: 'Strategy Director', roleEs: 'Director de Estrategia' },
      { id: 'member-7', name: 'Laura Díaz', role: 'Transformation Lead', roleEs: 'Líder de Transformación' },
      { id: 'member-8', name: 'Roberto Moreno', role: 'Executive Assistant', roleEs: 'Asistente Ejecutivo' },
    ],
    alignment: 92, 
  ...
  { 
    ...
    members: [
      { id: 'member-9', name: 'Carmen López', role: 'People Director', roleEs: 'Directora de Personas' },
      { id: 'member-10', name: 'Diego Ramírez', role: 'Culture Lead', roleEs: 'Líder de Cultura' },
      { id: 'member-11', name: 'Isabel Navarro', role: 'Talent Acquisition', roleEs: 'Adquisición de Talento' },
      { id: 'member-12', name: 'Fernando Castro', role: 'Learning & Development', roleEs: 'Aprendizaje y Desarrollo' },
      { id: 'member-13', name: 'Lucía Vega', role: 'Employee Experience', roleEs: 'Experiencia del Empleado' },
      { id: 'member-14', name: 'Miguel Ruiz', role: 'HR Business Partner', roleEs: 'HR Business Partner' },
      { id: 'member-15', name: 'Andrea Molina', role: 'Compensation & Benefits', roleEs: 'Compensación y Beneficios' },
      { id: 'member-16', name: 'Javier Ortiz', role: 'HR Coordinator', roleEs: 'Coordinador de RH' },
      { id: 'member-17', name: 'Patricia Herrera', role: 'Wellbeing Specialist', roleEs: 'Especialista en Bienestar' },
      { id: 'member-18', name: 'Antonio Vargas', role: 'HR Analyst', roleEs: 'Analista de RH' },
      { id: 'member-19', name: 'Sara Mendoza', role: 'Onboarding Specialist', roleEs: 'Especialista en Onboarding' },
      { id: 'member-20', name: 'Ricardo Flores', role: 'HR Operations', roleEs: 'Operaciones de RH' },
    ],
    alignment: 88, 
  ...
  { 
    ...
    members: [
      { id: 'member-21', name: 'Alejandro Jiménez', role: 'Revenue Director', roleEs: 'Director de Ingresos' },
      { id: 'member-22', name: 'Beatriz Romero', role: 'Sales Manager', roleEs: 'Gerente de Ventas' },
      { id: 'member-23', name: 'Cristian Delgado', role: 'Account Executive', roleEs: 'Ejecutivo de Cuenta' },
      { id: 'member-24', name: 'Diana Peña', role: 'Account Executive', roleEs: 'Ejecutivo de Cuenta' },
      { id: 'member-25', name: 'Eduardo Silva', role: 'Sales Development Rep', roleEs: 'Rep. Desarrollo de Ventas' },
      { id: 'member-26', name: 'Francisca Muñoz', role: 'Customer Success Manager', roleEs: 'Gerente de Éxito del Cliente' },
      { id: 'member-27', name: 'Gabriel Reyes', role: 'Customer Success Manager', roleEs: 'Gerente de Éxito del Cliente' },
      { id: 'member-28', name: 'Helena Castro', role: 'Revenue Analyst', roleEs: 'Analista de Ingresos' },
      { id: 'member-29', name: 'Iván Morales', role: 'Sales Operations', roleEs: 'Operaciones de Ventas' },
      { id: 'member-30', name: 'Julia Paredes', role: 'Renewals Specialist', roleEs: 'Especialista en Renovaciones' },
      { id: 'member-31', name: 'Kevin Rojas', role: 'Sales Engineer', roleEs: 'Ingeniero de Ventas' },
      { id: 'member-32', name: 'Lorena Guzmán', role: 'Solutions Consultant', roleEs: 'Consultor de Soluciones' },
      { id: 'member-33', name: 'Marcos Pinto', role: 'Account Executive', roleEs: 'Ejecutivo de Cuenta' },
      { id: 'member-34', name: 'Natalia Cruz', role: 'Sales Coordinator', roleEs: 'Coordinadora de Ventas' },
      { id: 'member-35', name: 'Oscar León', role: 'Business Development', roleEs: 'Desarrollo de Negocios' },
      { id: 'member-36', name: 'Paola Núñez', role: 'Partner Manager', roleEs: 'Gerente de Socios' },
      { id: 'member-37', name: 'Rodrigo Espinoza', role: 'Sales Trainer', roleEs: 'Capacitador de Ventas' },
      { id: 'member-38', name: 'Sofía Aguirre', role: 'CRM Administrator', roleEs: 'Administrador CRM' },
      { id: 'member-39', name: 'Tomás Valdés', role: 'Pricing Analyst', roleEs: 'Analista de Precios' },
      { id: 'member-40', name: 'Valentina Cortés', role: 'Revenue Operations Lead', roleEs: 'Líder de Revenue Ops' },
      { id: 'member-41', name: 'William Acosta', role: 'Enterprise Account Exec', roleEs: 'Ejecutivo de Cuenta Enterprise' },
      { id: 'member-42', name: 'Ximena Bravo', role: 'SMB Account Manager', roleEs: 'Gerente de Cuenta SMB' },
      { id: 'member-43', name: 'Yolanda Campos', role: 'Contract Specialist', roleEs: 'Especialista en Contratos' },
      { id: 'member-44', name: 'Zacarías Duarte', role: 'Sales Intern', roleEs: 'Practicante de Ventas' },
      { id: 'member-45', name: 'Amanda Fuentes', role: 'Market Research', roleEs: 'Investigación de Mercado' },
    ],
    alignment: 75, 
  ...
  { 
    ...
    members: [
      { id: 'member-46', name: 'Adrián Méndez', role: 'VP of Engineering', roleEs: 'VP de Ingeniería' },
      { id: 'member-47', name: 'Bianca Salazar', role: 'Product Director', roleEs: 'Directora de Producto' },
      { id: 'member-48', name: 'César Guerrero', role: 'Tech Lead', roleEs: 'Líder Técnico' },
      { id: 'member-49', name: 'Daniela Rivas', role: 'Product Manager', roleEs: 'Gerente de Producto' },
      { id: 'member-50', name: 'Ernesto Medina', role: 'Senior Engineer', roleEs: 'Ingeniero Senior' },
      { id: 'member-51', name: 'Fabiola Luna', role: 'Senior Engineer', roleEs: 'Ingeniero Senior' },
      { id: 'member-52', name: 'Gonzalo Vásquez', role: 'Full Stack Developer', roleEs: 'Desarrollador Full Stack' },
      { id: 'member-53', name: 'Hilda Peralta', role: 'Full Stack Developer', roleEs: 'Desarrollador Full Stack' },
      { id: 'member-54', name: 'Ignacio Córdova', role: 'Backend Developer', roleEs: 'Desarrollador Backend' },
      { id: 'member-55', name: 'Jimena Orozco', role: 'Frontend Developer', roleEs: 'Desarrollador Frontend' },
      { id: 'member-56', name: 'Leonardo Ibarra', role: 'Frontend Developer', roleEs: 'Desarrollador Frontend' },
      { id: 'member-57', name: 'Marina Quintero', role: 'UX Designer', roleEs: 'Diseñador UX' },
      { id: 'member-58', name: 'Nicolás Sandoval', role: 'UI Designer', roleEs: 'Diseñador UI' },
      { id: 'member-59', name: 'Olivia Carrasco', role: 'QA Engineer', roleEs: 'Ingeniero QA' },
      { id: 'member-60', name: 'Patricio Lagos', role: 'QA Engineer', roleEs: 'Ingeniero QA' },
      { id: 'member-61', name: 'Raquel Estrada', role: 'DevOps Engineer', roleEs: 'Ingeniero DevOps' },
      { id: 'member-62', name: 'Sebastián Alvarado', role: 'DevOps Engineer', roleEs: 'Ingeniero DevOps' },
      { id: 'member-63', name: 'Tamara Bernal', role: 'Data Engineer', roleEs: 'Ingeniero de Datos' },
      { id: 'member-64', name: 'Ulises Franco', role: 'Mobile Developer', roleEs: 'Desarrollador Mobile' },
      { id: 'member-65', name: 'Verónica Gálvez', role: 'Product Designer', roleEs: 'Diseñador de Producto' },
      { id: 'member-66', name: 'Walter Hidalgo', role: 'Security Engineer', roleEs: 'Ingeniero de Seguridad' },
      { id: 'member-67', name: 'Alejandra Iglesias', role: 'Technical Writer', roleEs: 'Escritor Técnico' },
      { id: 'member-68', name: 'Bruno Jaramillo', role: 'Junior Developer', roleEs: 'Desarrollador Junior' },
      { id: 'member-69', name: 'Camila Lara', role: 'Junior Developer', roleEs: 'Desarrollador Junior' },
      { id: 'member-70', name: 'David Mancilla', role: 'Engineering Manager', roleEs: 'Gerente de Ingeniería' },
      { id: 'member-71', name: 'Emilia Navarrete', role: 'Scrum Master', roleEs: 'Scrum Master' },
      { id: 'member-72', name: 'Felipe Oporto', role: 'Platform Engineer', roleEs: 'Ingeniero de Plataforma' },
      { id: 'member-73', name: 'Gabriela Palma', role: 'UX Researcher', roleEs: 'Investigador UX' },
      { id: 'member-74', name: 'Héctor Quiroga', role: 'ML Engineer', roleEs: 'Ingeniero ML' },
      { id: 'member-75', name: 'Inés Ríos', role: 'Data Scientist', roleEs: 'Científico de Datos' },
      { id: 'member-76', name: 'Jorge Salas', role: 'Backend Developer', roleEs: 'Desarrollador Backend' },
      { id: 'member-77', name: 'Karen Tapia', role: 'Product Analyst', roleEs: 'Analista de Producto' },
      { id: 'member-78', name: 'Luis Uribe', role: 'Infrastructure Lead', roleEs: 'Líder de Infraestructura' },
      { id: 'member-79', name: 'Mónica Vera', role: 'Release Manager', roleEs: 'Gerente de Releases' },
      { id: 'member-80', name: 'Nelson Zapata', role: 'Intern Developer', roleEs: 'Desarrollador Practicante' },
    ],
    alignment: 60, 
  ...
  { 
    ...
    members: [
      { id: 'member-81', name: 'Alberto Cifuentes', role: 'Innovation Director', roleEs: 'Director de Innovación' },
      { id: 'member-82', name: 'Bárbara Espinosa', role: 'Innovation Lead', roleEs: 'Líder de Innovación' },
      { id: 'member-83', name: 'Claudio Figueroa', role: 'Venture Designer', roleEs: 'Diseñador de Ventures' },
      { id: 'member-84', name: 'Delia Godoy', role: 'Business Analyst', roleEs: 'Analista de Negocios' },
      { id: 'member-85', name: 'Esteban Henríquez', role: 'Prototype Developer', roleEs: 'Desarrollador de Prototipos' },
      { id: 'member-86', name: 'Florencia Jara', role: 'Research Analyst', roleEs: 'Analista de Investigación' },
    ],
    alignment: 95, 
