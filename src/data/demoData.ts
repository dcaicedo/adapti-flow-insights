...
export const keyResults: KeyResult[] = [
  ...
  },
  {
    ...
    objectiveId: 'obj-6',
    teamIds: ['team-4', 'team-8', 'team-10', 'team-11', 'team-13'],
    progress: 42,
    investment: 180000,
    budget: 250000,
    status: 'critical',
...
export const teams: Team[] = [
  { 
    ...
    icon: '👔',
    members: [
      { id: 'member-1', name: 'María García', role: 'CEO', roleEs: 'CEO', unitType: 'core', hoursPerWeek: 36, area: 'Executive Office', areaEs: 'Oficina Ejecutiva' },
      { id: 'member-2', name: 'Carlos Rodríguez', role: 'COO', roleEs: 'COO', unitType: 'core', hoursPerWeek: 29, area: 'Executive Office', areaEs: 'Oficina Ejecutiva' },
      { id: 'member-3', name: 'Ana Martínez', role: 'CHRO', roleEs: 'CHRO', unitType: 'core', hoursPerWeek: 31, area: 'Human Resources', areaEs: 'Recursos Humanos' },
      { id: 'member-4', name: 'Luis Fernández', role: 'CFO', roleEs: 'CFO', unitType: 'core', hoursPerWeek: 28, area: 'Finance', areaEs: 'Finanzas' },
      { id: 'member-5', name: 'Elena Torres', role: 'CTO', roleEs: 'CTO', unitType: 'core', hoursPerWeek: 40, area: 'Technology', areaEs: 'Tecnología' },
      { id: 'member-6', name: 'Pablo Sánchez', role: 'Strategy Director', roleEs: 'Director de Estrategia', unitType: 'extended', hoursPerWeek: 14, area: 'Strategy', areaEs: 'Estrategia' },
      { id: 'member-7', name: 'Laura Díaz', role: 'Transformation Lead', roleEs: 'Líder de Transformación', unitType: 'extended', hoursPerWeek: 14, area: 'Consulting', areaEs: 'Consultoría' },
      { id: 'member-8', name: 'Roberto Moreno', role: 'Executive Assistant', roleEs: 'Asistente Ejecutivo', unitType: 'extended', hoursPerWeek: 11, area: 'Executive Office', areaEs: 'Oficina Ejecutiva' },
    ],
    alignment: 92, 
  ...
  { 
    ...
    icon: '💛',
    members: [
      { id: 'member-9', name: 'Carmen López', role: 'People Director', roleEs: 'Directora de Personas', unitType: 'core', hoursPerWeek: 37, area: 'Human Resources', areaEs: 'Recursos Humanos' },
      { id: 'member-10', name: 'Diego Ramírez', role: 'Culture Lead', roleEs: 'Líder de Cultura', unitType: 'core', hoursPerWeek: 39, area: 'Human Resources', areaEs: 'Recursos Humanos' },
      { id: 'member-11', name: 'Isabel Navarro', role: 'Talent Acquisition', roleEs: 'Adquisición de Talento', unitType: 'core', hoursPerWeek: 32, area: 'Human Resources', areaEs: 'Recursos Humanos' },
      { id: 'member-12', name: 'Fernando Castro', role: 'Learning & Development', roleEs: 'Aprendizaje y Desarrollo', unitType: 'core', hoursPerWeek: 29, area: 'Human Resources', areaEs: 'Recursos Humanos' },
      { id: 'member-13', name: 'Lucía Vega', role: 'Employee Experience', roleEs: 'Experiencia del Empleado', unitType: 'extended', hoursPerWeek: 11, area: 'Operations', areaEs: 'Operaciones' },
      { id: 'member-14', name: 'Miguel Ruiz', role: 'HR Business Partner', roleEs: 'HR Business Partner', unitType: 'extended', hoursPerWeek: 10, area: 'Consulting', areaEs: 'Consultoría' },
      { id: 'member-15', name: 'Andrea Molina', role: 'Compensation & Benefits', roleEs: 'Compensación y Beneficios', unitType: 'extended', hoursPerWeek: 12, area: 'Finance', areaEs: 'Finanzas' },
      { id: 'member-16', name: 'Javier Ortiz', role: 'HR Coordinator', roleEs: 'Coordinador de RH', unitType: 'extended', hoursPerWeek: 9, area: 'Human Resources', areaEs: 'Recursos Humanos' },
    ],
    alignment: 88, 
  ...
  { 
    ...
    icon: '💰',
    members: [
      { id: 'member-21', name: 'Alejandro Jiménez', role: 'Revenue Director', roleEs: 'Director de Ingresos', unitType: 'core', hoursPerWeek: 33, area: 'Sales', areaEs: 'Ventas' },
      { id: 'member-22', name: 'Beatriz Romero', role: 'Sales Manager', roleEs: 'Gerente de Ventas', unitType: 'core', hoursPerWeek: 38, area: 'Sales', areaEs: 'Ventas' },
      { id: 'member-23', name: 'Cristian Delgado', role: 'Account Executive', roleEs: 'Ejecutivo de Cuenta', unitType: 'core', hoursPerWeek: 36, area: 'Sales', areaEs: 'Ventas' },
      { id: 'member-24', name: 'Diana Peña', role: 'Account Executive', roleEs: 'Ejecutivo de Cuenta', unitType: 'core', hoursPerWeek: 26, area: 'Sales', areaEs: 'Ventas' },
      { id: 'member-25', name: 'Eduardo Silva', role: 'Sales Development Rep', roleEs: 'Rep. Desarrollo de Ventas', unitType: 'core', hoursPerWeek: 33, area: 'Sales', areaEs: 'Ventas' },
      { id: 'member-26', name: 'Francisca Muñoz', role: 'Customer Success Manager', roleEs: 'Gerente de Éxito del Cliente', unitType: 'core', hoursPerWeek: 27, area: 'Customer Success', areaEs: 'Éxito del Cliente' },
      { id: 'member-27', name: 'Gabriel Reyes', role: 'Customer Success Manager', roleEs: 'Gerente de Éxito del Cliente', unitType: 'extended', hoursPerWeek: 18, area: 'Customer Success', areaEs: 'Éxito del Cliente' },
      { id: 'member-28', name: 'Helena Castro', role: 'Revenue Analyst', roleEs: 'Analista de Ingresos', unitType: 'extended', hoursPerWeek: 14, area: 'Finance', areaEs: 'Finanzas' },
      { id: 'member-29', name: 'Iván Morales', role: 'Sales Operations', roleEs: 'Operaciones de Ventas', unitType: 'extended', hoursPerWeek: 14, area: 'Operations', areaEs: 'Operaciones' },
      { id: 'member-30', name: 'Julia Paredes', role: 'Renewals Specialist', roleEs: 'Especialista en Renovaciones', unitType: 'extended', hoursPerWeek: 13, area: 'Sales', areaEs: 'Ventas' },
    ],
    alignment: 75, 
  ...
  { 
    ...
    icon: '⚙️',
    members: [
      { id: 'member-46', name: 'Adrián Méndez', role: 'VP of Engineering', roleEs: 'VP de Ingeniería', unitType: 'core', hoursPerWeek: 25, area: 'Technology', areaEs: 'Tecnología' },
      { id: 'member-47', name: 'Bianca Salazar', role: 'Product Director', roleEs: 'Directora de Producto', unitType: 'core', hoursPerWeek: 25, area: 'Product', areaEs: 'Producto' },
      { id: 'member-48', name: 'César Guerrero', role: 'Tech Lead', roleEs: 'Líder Técnico', unitType: 'core', hoursPerWeek: 40, area: 'Technology', areaEs: 'Tecnología' },
      { id: 'member-49', name: 'Daniela Rivas', role: 'Product Manager', roleEs: 'Gerente de Producto', unitType: 'core', hoursPerWeek: 39, area: 'Product', areaEs: 'Producto' },
      { id: 'member-50', name: 'Ernesto Medina', role: 'Senior Engineer', roleEs: 'Ingeniero Senior', unitType: 'core', hoursPerWeek: 37, area: 'Technology', areaEs: 'Tecnología' },
      { id: 'member-51', name: 'Fabiola Luna', role: 'Senior Engineer', roleEs: 'Ingeniero Senior', unitType: 'core', hoursPerWeek: 34, area: 'Technology', areaEs: 'Tecnología' },
      { id: 'member-52', name: 'Gonzalo Vásquez', role: 'Full Stack Developer', roleEs: 'Desarrollador Full Stack', unitType: 'extended', hoursPerWeek: 17, area: 'Technology', areaEs: 'Tecnología' },
      { id: 'member-53', name: 'Hilda Peralta', role: 'Full Stack Developer', roleEs: 'Desarrollador Full Stack', unitType: 'extended', hoursPerWeek: 15, area: 'Technology', areaEs: 'Tecnología' },
      { id: 'member-54', name: 'Ignacio Córdova', role: 'Backend Developer', roleEs: 'Desarrollador Backend', unitType: 'extended', hoursPerWeek: 12, area: 'Technology', areaEs: 'Tecnología' },
      { id: 'member-55', name: 'Jimena Orozco', role: 'UX Designer', roleEs: 'Diseñador UX', unitType: 'extended', hoursPerWeek: 13, area: 'Design', areaEs: 'Diseño' },
      { id: 'member-56', name: 'Leonardo Ibarra', role: 'QA Engineer', roleEs: 'Ingeniero QA', unitType: 'extended', hoursPerWeek: 11, area: 'Quality', areaEs: 'Calidad' },
    ],
    alignment: 60, 
  ...
  { 
    ...
    icon: '🚀',
    members: [
      { id: 'member-81', name: 'Alberto Cifuentes', role: 'Innovation Director', roleEs: 'Director de Innovación', unitType: 'core', hoursPerWeek: 35, area: 'Innovation', areaEs: 'Innovación' },
      { id: 'member-82', name: 'Bárbara Espinosa', role: 'Innovation Lead', roleEs: 'Líder de Innovación', unitType: 'core', hoursPerWeek: 30, area: 'Innovation', areaEs: 'Innovación' },
      { id: 'member-83', name: 'Claudio Figueroa', role: 'Venture Designer', roleEs: 'Diseñador de Ventures', unitType: 'core', hoursPerWeek: 26, area: 'Innovation', areaEs: 'Innovación' },
      { id: 'member-84', name: 'Delia Godoy', role: 'Business Analyst', roleEs: 'Analista de Negocios', unitType: 'extended', hoursPerWeek: 14, area: 'Strategy', areaEs: 'Estrategia' },
      { id: 'member-85', name: 'Esteban Henríquez', role: 'Prototype Developer', roleEs: 'Desarrollador de Prototipos', unitType: 'extended', hoursPerWeek: 10, area: 'Technology', areaEs: 'Tecnología' },
      { id: 'member-86', name: 'Florencia Jara', role: 'Research Analyst', roleEs: 'Analista de Investigación', unitType: 'extended', hoursPerWeek: 13, area: 'Research', areaEs: 'Investigación' },
    ],
    alignment: 95, 
  ...
  { 
    ...
    icon: '📢',
    members: [
      { id: 'member-87', name: 'Valentina Rojas', role: 'Marketing Director', roleEs: 'Directora de Marketing', unitType: 'core', hoursPerWeek: 28, area: 'Marketing', areaEs: 'Marketing' },
      { id: 'member-88', name: 'Sebastián Mora', role: 'Brand Manager', roleEs: 'Gerente de Marca', unitType: 'core', hoursPerWeek: 26, area: 'Marketing', areaEs: 'Marketing' },
      { id: 'member-89', name: 'Catalina Vidal', role: 'Content Lead', roleEs: 'Líder de Contenido', unitType: 'core', hoursPerWeek: 40, area: 'Marketing', areaEs: 'Marketing' },
      { id: 'member-90', name: 'Andrés Pizarro', role: 'Digital Marketing', roleEs: 'Marketing Digital', unitType: 'core', hoursPerWeek: 33, area: 'Marketing', areaEs: 'Marketing' },
      { id: 'member-91', name: 'Fernanda Silva', role: 'Communications Lead', roleEs: 'Líder de Comunicaciones', unitType: 'extended', hoursPerWeek: 9, area: 'Communications', areaEs: 'Comunicaciones' },
      { id: 'member-92', name: 'Ricardo Bravo', role: 'Social Media Manager', roleEs: 'Gerente de Redes Sociales', unitType: 'extended', hoursPerWeek: 20, area: 'Marketing', areaEs: 'Marketing' },
      { id: 'member-93', name: 'Mónica Araya', role: 'Marketing Analyst', roleEs: 'Analista de Marketing', unitType: 'extended', hoursPerWeek: 13, area: 'Analytics', areaEs: 'Analíticas' },
    ],
    alignment: 78, 
    keyResultIds: ['kr-7'], 
  ...
  { 
    ...
    icon: '📊',
    members: [
      { id: 'member-94', name: 'Rodrigo Campos', role: 'Finance Director', roleEs: 'Director de Finanzas', unitType: 'core', hoursPerWeek: 28, area: 'Finance', areaEs: 'Finanzas' },
      { id: 'member-95', name: 'Patricia Herrera', role: 'Controller', roleEs: 'Controller', unitType: 'core', hoursPerWeek: 33, area: 'Finance', areaEs: 'Finanzas' },
      { id: 'member-96', name: 'Mauricio Lagos', role: 'FP&A Manager', roleEs: 'Gerente de FP&A', unitType: 'core', hoursPerWeek: 40, area: 'Finance', areaEs: 'Finanzas' },
      { id: 'member-97', name: 'Carolina Núñez', role: 'Treasury', roleEs: 'Tesorería', unitType: 'extended', hoursPerWeek: 10, area: 'Finance', areaEs: 'Finanzas' },
      { id: 'member-98', name: 'Jorge Valdés', role: 'Senior Accountant', roleEs: 'Contador Senior', unitType: 'extended', hoursPerWeek: 16, area: 'Accounting', areaEs: 'Contabilidad' },
      { id: 'member-99', name: 'Daniela Fuentes', role: 'Tax Specialist', roleEs: 'Especialista Tributario', unitType: 'extended', hoursPerWeek: 13, area: 'Tax', areaEs: 'Impuestos' },
    ],
    alignment: 82, 
  ...
  { 
    ...
    icon: '🖥️',
    members: [
      { id: 'member-100', name: 'Manuel Ortega', role: 'IT Director', roleEs: 'Director de TI', unitType: 'core', hoursPerWeek: 36, area: 'Technology', areaEs: 'Tecnología' },
      { id: 'member-101', name: 'Claudia Sepúlveda', role: 'Security Lead', roleEs: 'Líder de Seguridad', unitType: 'core', hoursPerWeek: 28, area: 'Technology', areaEs: 'Tecnología' },
      { id: 'member-102', name: 'Felipe Aravena', role: 'Infrastructure Manager', roleEs: 'Gerente de Infraestructura', unitType: 'core', hoursPerWeek: 37, area: 'Technology', areaEs: 'Tecnología' },
      { id: 'member-103', name: 'Lorena Carrasco', role: 'IT Support Lead', roleEs: 'Líder de Soporte TI', unitType: 'extended', hoursPerWeek: 18, area: 'Operations', areaEs: 'Operaciones' },
      { id: 'member-104', name: 'Nicolás Soto', role: 'Network Admin', roleEs: 'Admin de Redes', unitType: 'extended', hoursPerWeek: 9, area: 'Technology', areaEs: 'Tecnología' },
      { id: 'member-105', name: 'Alejandra Peña', role: 'Systems Analyst', roleEs: 'Analista de Sistemas', unitType: 'extended', hoursPerWeek: 8, area: 'Technology', areaEs: 'Tecnología' },
    ],
    alignment: 70, 
    keyResultIds: ['kr-9'], 
  ...
  { 
    ...
    icon: '⚖️',
    members: [
      { id: 'member-106', name: 'Gonzalo Martín', role: 'General Counsel', roleEs: 'Consejero General', unitType: 'core', hoursPerWeek: 35, area: 'Legal', areaEs: 'Legal' },
      { id: 'member-107', name: 'Francisca Guzmán', role: 'Compliance Director', roleEs: 'Directora de Cumplimiento', unitType: 'core', hoursPerWeek: 31, area: 'Legal', areaEs: 'Legal' },
      { id: 'member-108', name: 'Tomás Rivera', role: 'Corporate Lawyer', roleEs: 'Abogado Corporativo', unitType: 'core', hoursPerWeek: 29, area: 'Legal', areaEs: 'Legal' },
      { id: 'member-109', name: 'Victoria Salinas', role: 'Privacy Officer', roleEs: 'Oficial de Privacidad', unitType: 'extended', hoursPerWeek: 14, area: 'Legal', areaEs: 'Legal' },
      { id: 'member-110', name: 'Eduardo Castillo', role: 'Contract Manager', roleEs: 'Gerente de Contratos', unitType: 'extended', hoursPerWeek: 14, area: 'Legal', areaEs: 'Legal' },
    ],
    alignment: 85, 
    keyResultIds: ['kr-10'], 
  ...
  { 
    ...
    icon: '⭐',
    members: [
      { id: 'member-111', name: 'Ignacio Poblete', role: 'Operations Director', roleEs: 'Director de Operaciones', unitType: 'core', hoursPerWeek: 40, area: 'Operations', areaEs: 'Operaciones' },
      { id: 'member-112', name: 'Macarena Flores', role: 'Process Lead', roleEs: 'Líder de Procesos', unitType: 'core', hoursPerWeek: 30, area: 'Operations', areaEs: 'Operaciones' },
      { id: 'member-113', name: 'Roberto Vargas', role: 'Quality Manager', roleEs: 'Gerente de Calidad', unitType: 'core', hoursPerWeek: 37, area: 'Quality', areaEs: 'Calidad' },
      { id: 'member-114', name: 'Carla Montenegro', role: 'Continuous Improvement', roleEs: 'Mejora Continua', unitType: 'extended', hoursPerWeek: 11, area: 'Operations', areaEs: 'Operaciones' },
      { id: 'member-115', name: 'Pablo Espinoza', role: 'Project Manager', roleEs: 'Gerente de Proyectos', unitType: 'extended', hoursPerWeek: 16, area: 'PMO', areaEs: 'PMO' },
      { id: 'member-116', name: 'Camila Rodríguez', role: 'Business Analyst', roleEs: 'Analista de Negocios', unitType: 'extended', hoursPerWeek: 19, area: 'Strategy', areaEs: 'Estrategia' },
    ],
    alignment: 80, 
  ...
  },
  {
    ...
    icon: '🤖',
    members: [
      { id: 'member-120', name: 'Sarah Chen', role: 'AI Product Lead', roleEs: 'Líder de Producto IA', unitType: 'core', hoursPerWeek: 32, area: 'AI', areaEs: 'IA' },
      { id: 'member-121', name: 'James Wilson', role: 'ML Engineer', roleEs: 'Ingeniero ML', unitType: 'core', hoursPerWeek: 39, area: 'AI', areaEs: 'IA' },
      { id: 'member-122', name: 'Priya Sharma', role: 'Data Scientist', roleEs: 'Científica de Datos', unitType: 'core', hoursPerWeek: 32, area: 'AI', areaEs: 'IA' },
      { id: 'member-123', name: 'Marcus Johnson', role: 'Full Stack Developer', roleEs: 'Desarrollador Full Stack', unitType: 'core', hoursPerWeek: 40, area: 'Technology', areaEs: 'Tecnología' },
      { id: 'member-124', name: 'Aisha Patel', role: 'Backend Engineer', roleEs: 'Ingeniera Backend', unitType: 'core', hoursPerWeek: 30, area: 'Technology', areaEs: 'Tecnología' },
      { id: 'member-125', name: 'David Kim', role: 'DevOps Engineer', roleEs: 'Ingeniero DevOps', unitType: 'core', hoursPerWeek: 37, area: 'Technology', areaEs: 'Tecnología' },
      { id: 'member-126', name: 'Emma Thompson', role: 'UX Researcher', roleEs: 'Investigadora UX', unitType: 'extended', hoursPerWeek: 18, area: 'Design', areaEs: 'Diseño' },
      { id: 'member-127', name: 'Carlos Medina', role: 'QA Automation', roleEs: 'QA Automatización', unitType: 'extended', hoursPerWeek: 17, area: 'Quality', areaEs: 'Calidad' },
    ],
    alignment: 88,
  ...
  },
  {
    ...
    icon: '🛒',
    members: [
      { id: 'member-130', name: 'Lisa Wang', role: 'Product Manager', roleEs: 'Gerente de Producto', unitType: 'core', hoursPerWeek: 37, area: 'Product', areaEs: 'Producto' },
      { id: 'member-131', name: 'Ryan O\'Brien', role: 'Senior Engineer', roleEs: 'Ingeniero Senior', unitType: 'core', hoursPerWeek: 33, area: 'Technology', areaEs: 'Tecnología' },
      { id: 'member-132', name: 'Fatima Al-Hassan', role: 'AI/ML Specialist', roleEs: 'Especialista IA/ML', unitType: 'core', hoursPerWeek: 30, area: 'AI', areaEs: 'IA' },
      { id: 'member-133', name: 'Alex Tremblay', role: 'Frontend Developer', roleEs: 'Desarrollador Frontend', unitType: 'core', hoursPerWeek: 30, area: 'Technology', areaEs: 'Tecnología' },
      { id: 'member-134', name: 'Sophie Dubois', role: 'Data Engineer', roleEs: 'Ingeniera de Datos', unitType: 'core', hoursPerWeek: 30, area: 'Technology', areaEs: 'Tecnología' },
      { id: 'member-135', name: 'Nathan Scott', role: 'Platform Engineer', roleEs: 'Ingeniero de Plataforma', unitType: 'extended', hoursPerWeek: 13, area: 'Technology', areaEs: 'Tecnología' },
      { id: 'member-136', name: 'Maria Santos', role: 'UX Designer', roleEs: 'Diseñadora UX', unitType: 'extended', hoursPerWeek: 15, area: 'Design', areaEs: 'Diseño' },
    ],
    alignment: 82,
  ...
  },
  {
    ...
    icon: '🧠',
    members: [
      { id: 'member-140', name: 'Jennifer Lee', role: 'Engineering Manager', roleEs: 'Gerente de Ingeniería', unitType: 'core', hoursPerWeek: 26, area: 'Technology', areaEs: 'Tecnología' },
      { id: 'member-141', name: 'Michael Brown', role: 'ML Engineer', roleEs: 'Ingeniero ML', unitType: 'core', hoursPerWeek: 32, area: 'AI', areaEs: 'IA' },
      { id: 'member-142', name: 'Ananya Gupta', role: 'Data Scientist', roleEs: 'Científica de Datos', unitType: 'core', hoursPerWeek: 32, area: 'AI', areaEs: 'IA' },
      { id: 'member-143', name: 'Thomas Bernier', role: 'Backend Developer', roleEs: 'Desarrollador Backend', unitType: 'core', hoursPerWeek: 25, area: 'Technology', areaEs: 'Tecnología' },
      { id: 'member-144', name: 'Rachel Green', role: 'Frontend Developer', roleEs: 'Desarrolladora Frontend', unitType: 'core', hoursPerWeek: 36, area: 'Technology', areaEs: 'Tecnología' },
      { id: 'member-145', name: 'Omar Hassan', role: 'SRE Engineer', roleEs: 'Ingeniero SRE', unitType: 'extended', hoursPerWeek: 13, area: 'Technology', areaEs: 'Tecnología' },
      { id: 'member-146', name: 'Laura Gagné', role: 'Product Designer', roleEs: 'Diseñadora de Producto', unitType: 'extended', hoursPerWeek: 13, area: 'Design', areaEs: 'Diseño' },
    ],
    alignment: 85,
